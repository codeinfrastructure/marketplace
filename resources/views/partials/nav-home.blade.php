<nav class="bg-gray-900 shadow sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="mobile-menu"
             class="hidden md:hidden pb-4 border-t border-gray-700">

            <a href="{{ route('home') }}"
               class="block px-3 py-2 text-white hover:text-blue-400 hover:bg-gray-800 rounded transition">
                Home
            </a>
            ...
            @guest
                <a href="{{ route('login') }}"
                   class="block px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition mt-2">
                    Login
                </a>
            @endguest
            ...
            @auth
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit"
                            class="w-full text-left px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition mt-2">
                        Logout
                    </button>
                </form>
            @endauth
